...
class LocalizationTypeSpec(object):
    ...
    def __init__(self, attribute_types=None, color_map=None, description=None, dtype=None, line_width=None, media_types=None, name=None, visible=True):  # noqa: E501
        """LocalizationTypeSpec - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LocalizationTypeSpec, dict):
