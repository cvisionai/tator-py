...
class BoxUpdate(object):
    ...
    def __init__(self, attributes=None, frame=None, height=None, width=None, x=None, y=None, local_vars_configuration=None):  # noqa: E501
        """BoxUpdate - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def attributes(self):
        """Gets the attributes of this BoxUpdate.  # noqa: E501

        Object containing attribute values.  # noqa: E501

        :return: The attributes of this BoxUpdate.  # noqa: E501
    ...
    def attributes(self, attributes):
        """Sets the attributes of this BoxUpdate.

        Object containing attribute values.  # noqa: E501

        :param attributes: The attributes of this BoxUpdate.  # noqa: E501
    ...
    @property
    def frame(self):
        """Gets the frame of this BoxUpdate.  # noqa: E501

        Frame number of this localization if it is in a video.  # noqa: E501

        :return: The frame of this BoxUpdate.  # noqa: E501
        :rtype: int
        """
        return self._frame
    ...
    def frame(self, frame):
        """Sets the frame of this BoxUpdate.

        Frame number of this localization if it is in a video.  # noqa: E501

        :param frame: The frame of this BoxUpdate.  # noqa: E501
        :type: int
        """
    ...
    @property
    def height(self):
        """Gets the height of this BoxUpdate.  # noqa: E501

        Normalized height of bounding box for `box` localization types.  # noqa: E501

        :return: The height of this BoxUpdate.  # noqa: E501
        :rtype: float
        """
        return self._height
    ...
    def height(self, height):
        """Sets the height of this BoxUpdate.

        Normalized height of bounding box for `box` localization types.  # noqa: E501

        :param height: The height of this BoxUpdate.  # noqa: E501
        :type: float
        """
    ...
    @property
    def width(self):
        """Gets the width of this BoxUpdate.  # noqa: E501

        Normalized width of bounding box for `box` localization types.  # noqa: E501

        :return: The width of this BoxUpdate.  # noqa: E501
        :rtype: float
        """
        return self._width
    ...
    def width(self, width):
        """Sets the width of this BoxUpdate.

        Normalized width of bounding box for `box` localization types.  # noqa: E501

        :param width: The width of this BoxUpdate.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def x(self):
        """Gets the x of this BoxUpdate.  # noqa: E501

        Normalized horizontal position of left edge of bounding box.  # noqa: E501

        :return: The x of this BoxUpdate.  # noqa: E501
        :rtype: float
        """
        return self._x
    ...
    @x.setter
    def x(self, x):
        """Sets the x of this BoxUpdate.

        Normalized horizontal position of left edge of bounding box.  # noqa: E501

        :param x: The x of this BoxUpdate.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def y(self):
        """Gets the y of this BoxUpdate.  # noqa: E501

        Normalized vertical position of top edge of bounding box.  # noqa: E501

        :return: The y of this BoxUpdate.  # noqa: E501
        :rtype: float
        """
        return self._y
    ...
    @y.setter
    def y(self, y):
        """Sets the y of this BoxUpdate.

        Normalized vertical position of top edge of bounding box.  # noqa: E501

        :param y: The y of this BoxUpdate.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BoxUpdate):
            return False
