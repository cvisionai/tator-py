...
class LineUpdate(object):
    ...
    @property
    def attributes(self):
        """Gets the attributes of this LineUpdate.  # noqa: E501

        Object containing attribute values.  # noqa: E501

        :return: The attributes of this LineUpdate.  # noqa: E501
    ...
    def attributes(self, attributes):
        """Sets the attributes of this LineUpdate.

        Object containing attribute values.  # noqa: E501

        :param attributes: The attributes of this LineUpdate.  # noqa: E501
    ...
    @property
    def frame(self):
        """Gets the frame of this LineUpdate.  # noqa: E501

        Frame number of this localization if it is in a video.  # noqa: E501

        :return: The frame of this LineUpdate.  # noqa: E501
        :rtype: int
        """
        return self._frame
    ...
    def frame(self, frame):
        """Sets the frame of this LineUpdate.

        Frame number of this localization if it is in a video.  # noqa: E501

        :param frame: The frame of this LineUpdate.  # noqa: E501
        :type: int
        """
    ...
    @x0.setter
    def x0(self, x0):
        """Sets the x0 of this LineUpdate.

        Normalized horizontal position of start of line for `line` localization types.  # noqa: E501

        :param x0: The x0 of this LineUpdate.  # noqa: E501
        :type: float
        """
    ...
    @x1.setter
    def x1(self, x1):
        """Sets the x1 of this LineUpdate.

        Normalized horizontal position of end of line for `line` localization types.  # noqa: E501

        :param x1: The x1 of this LineUpdate.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @y0.setter
    def y0(self, y0):
        """Sets the y0 of this LineUpdate.

        Normalized vertical position of start of line for `line` localization types.  # noqa: E501

        :param y0: The y0 of this LineUpdate.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def y1(self):
        """Gets the y1 of this LineUpdate.  # noqa: E501

        Normalized vertical position of end of line for `line` localization types.  # noqa: E501

        :return: The y1 of this LineUpdate.  # noqa: E501
        :rtype: float
        """
        return self._y1
    ...
    @y1.setter
    def y1(self, y1):
        """Sets the y1 of this LineUpdate.

        Normalized vertical position of end of line for `line` localization types.  # noqa: E501

        :param y1: The y1 of this LineUpdate.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
