...
*TatorApi* | [**create_media**](docs/TatorApi.md#create_media) | **POST** /rest/Medias/{project} | 
...
*TatorApi* | [**get_localization_graphic**](docs/TatorApi.md#get_localization_graphic) | **GET** /rest/LocalizationGraphic/{id} | 
...
## Documentation For Models
 ...
 - [EncodeConfig](docs/EncodeConfig.md)
 - [Leaf](docs/Leaf.md)
 ...
 - [MoveVideoSpec](docs/MoveVideoSpec.md)
