...
class LineSpec(object):
    ...
    @property
    def media_id(self):
        """Gets the media_id of this LineSpec.  # noqa: E501

        Unique integer identifying a media. Required if `many` is not given.  # noqa: E501

        :return: The media_id of this LineSpec.  # noqa: E501
        :rtype: int
        """
    ...
    def media_id(self, media_id):
        """Sets the media_id of this LineSpec.

        Unique integer identifying a media. Required if `many` is not given.  # noqa: E501

        :param media_id: The media_id of this LineSpec.  # noqa: E501
        :type: int
        """
    ...
    @property
    def modified(self):
        """Gets the modified of this LineSpec.  # noqa: E501

        Whether this localization was created in the web UI.  # noqa: E501

        :return: The modified of this LineSpec.  # noqa: E501
        :rtype: bool
        """
    ...
    def modified(self, modified):
        """Sets the modified of this LineSpec.

        Whether this localization was created in the web UI.  # noqa: E501

        :param modified: The modified of this LineSpec.  # noqa: E501
        :type: bool
        """
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this LineSpec.

        Unique integer identifying a localization type.Required if `many` is not given.  # noqa: E501

        :param type: The type of this LineSpec.  # noqa: E501
        :type: int
        """
    ...
    @property
    def version(self):
        """Gets the version of this LineSpec.  # noqa: E501

        Unique integer identifying the version.  # noqa: E501

        :return: The version of this LineSpec.  # noqa: E501
        :rtype: int
        """
    ...
    def version(self, version):
        """Sets the version of this LineSpec.

        Unique integer identifying the version.  # noqa: E501

        :param version: The version of this LineSpec.  # noqa: E501
        :type: int
        """
    ...
    @x0.setter
    def x0(self, x0):
        """Sets the x0 of this LineSpec.

        Normalized horizontal position of start of line for `line` localization types.  # noqa: E501

        :param x0: The x0 of this LineSpec.  # noqa: E501
        :type: float
        """
    ...
    @x1.setter
    def x1(self, x1):
        """Sets the x1 of this LineSpec.

        Normalized horizontal position of end of line for `line` localization types.  # noqa: E501

        :param x1: The x1 of this LineSpec.  # noqa: E501
        :type: float
        """
    ...
    @y0.setter
    def y0(self, y0):
        """Sets the y0 of this LineSpec.

        Normalized vertical position of start of line for `line` localization types.  # noqa: E501

        :param y0: The y0 of this LineSpec.  # noqa: E501
        :type: float
        """
    ...
    @y1.setter
    def y1(self, y1):
        """Sets the y1 of this LineSpec.

        Normalized vertical position of end of line for `line` localization types.  # noqa: E501

        :param y1: The y1 of this LineSpec.  # noqa: E501
        :type: float
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LineSpec):
            return False
