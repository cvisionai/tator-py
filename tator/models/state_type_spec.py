...
class StateTypeSpec(object):
    ...
    def __init__(self, association=None, attribute_types=None, description=None, media_types=None, name=None):  # noqa: E501
        """StateTypeSpec - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StateTypeSpec, dict):
