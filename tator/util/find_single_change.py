...
def find_single_change(
    ...
    def change_log_is_a_match(cl):
        ...
        if old_value is not None:
            old_change = tator.models.ChangeLogDescriptionOfChangeNew(name=field_name, value=old_value)
            matches = matches and old_change in cl.description_of_change.old

        if new_value is not None:
            new_change = tator.models.ChangeLogDescriptionOfChangeNew(name=field_name, value=new_value)
