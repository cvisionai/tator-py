...
class LocalizationSpec(object):
    ...
    def __init__(self, height=None, media_id=None, modified=False, type=None, version=None, width=None, x=None, y=None, x0=None, x1=None, y0=None, y1=None, many=None, local_vars_configuration=None):  # noqa: E501
