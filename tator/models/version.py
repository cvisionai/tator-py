...
class Version(object):
    ...
    def __init__(self, bases=None, created_by=None, created_datetime=None, description='', id=None, modified_by=None, modified_datetime=None, name=None, num_created=None, num_modified=None, number=None, project=None, show_empty=False):  # noqa: E501
