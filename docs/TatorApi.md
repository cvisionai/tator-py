...
# **algorithm_launch**
> AlgorithmLaunchResponse algorithm_launch(project)
...
# **create_analysis**
> CreateResponse create_analysis(project)
...
# **create_localization**
> MessageResponse create_localization(project)
...
> InlineResponse20013 create_obtain_auth_token(body=body)
...
> list[InlineResponse2001] get_localization_type_list(project, media_id=media_id, type=type)
...
# **get_media_type_list**
> list[InlineResponse2006] get_media_type_list(project)
...
# **get_state_type**
> InlineResponse2009 get_state_type(id)
...
# **get_tree_leaf_type**
> InlineResponse20015 get_tree_leaf_type(id)
...
> list[InlineResponse20016] get_tree_leaf_type_list(project)
...
# **get_user**
> InlineResponse20019 get_user(id)
...
# **get_version**
> InlineResponse20020 get_version(id)
...
> partial_update_save_video_api(project)
...
------------- | ------------- | ------------- | -------------
 **project** | **int**| A unique integer identifying a project. | 
 **body** | [**list[Body10]**](Body10.md)|  | [optional] 
...
> list[InlineResponse20020] retrieve_version_list(project, media_id=media_id)
...
# **save_video**
> CreateResponse save_video(project)
...
> list[InlineResponse20017] tree_leaf_suggestion(project, ancestor, query, min_level=min_level)
...
> MessageResponse update_attribute_type(id)
...
# **update_localization**
> MessageResponse update_localization(id)
...
> MessageResponse update_localization_association(id)
...
> MessageResponse update_localization_list(project, media_query=media_query, media_id=media_id, type=type, version=version, modified=modified, after=after, search=search, attribute=attribute, attribute_lt=attribute_lt, attribute_lte=attribute_lte, attribute_gt=attribute_gt, attribute_gte=attribute_gte, attribute_contains=attribute_contains, attribute_distance=attribute_distance, attribute_null=attribute_null, operation=operation, start=start, stop=stop)
...
# **update_user**
> InlineResponse20019 update_user(id, body=body)
