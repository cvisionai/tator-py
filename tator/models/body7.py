...
class Body7(object):
    ...
    @property
    def gid(self):
        """Gets the gid of this Body7.  # noqa: E501
        ...
        :return: The gid of this Body7.  # noqa: E501
        :rtype: str
        """
        return self._gid
    ...
    @gid.setter
    def gid(self, gid):
        """Sets the gid of this Body7.

        UUID generated for the job group. This value is returned in the response of the `AlgorithmLaunch` and `Transcode` endpoints.  # noqa: E501

        :param gid: The gid of this Body7.  # noqa: E501
        :type: str
        """
        if gid is None:
    ...
    @property
    def job_type(self):
        """Gets the job_type of this Body7.  # noqa: E501

        Type of background job.  # noqa: E501

        :return: The job_type of this Body7.  # noqa: E501
        :rtype: str
        """
    ...
    def job_type(self, job_type):
        """Sets the job_type of this Body7.

        Type of background job.  # noqa: E501

        :param job_type: The job_type of this Body7.  # noqa: E501
        :type: str
        """
        if job_type is None:
    ...
    @property
    def media_ids(self):
        """Gets the media_ids of this Body7.  # noqa: E501
        ...
        :return: The media_ids of this Body7.  # noqa: E501
        :rtype: str
        """
    ...
    def media_ids(self, media_ids):
        """Sets the media_ids of this Body7.

        Comma separated string of media ids, one for each media that this job applies to. Required only for `job_type` of `algorithm`.  # noqa: E501

        :param media_ids: The media_ids of this Body7.  # noqa: E501
        :type: str
        """
    ...
    def progress(self, progress):
        """Sets the progress of this Body7.

        Progress percent completion. This is used to display the progress bar associated with the job.  # noqa: E501

        :param progress: The progress of this Body7.  # noqa: E501
        :type: float
        """
        if progress is None:
    ...
    @property
    def section(self):
        """Gets the section of this Body7.  # noqa: E501

        Media section name. Required only for `job_type` of `upload`.  # noqa: E501

        :return: The section of this Body7.  # noqa: E501
        :rtype: str
        """
    ...
    def section(self, section):
        """Sets the section of this Body7.

        Media section name. Required only for `job_type` of `upload`.  # noqa: E501

        :param section: The section of this Body7.  # noqa: E501
        :type: str
        """
    ...
    @property
    def sections(self):
        """Gets the sections of this Body7.  # noqa: E501
        ...
        :return: The sections of this Body7.  # noqa: E501
        :rtype: str
        """
    ...
    def sections(self, sections):
        """Sets the sections of this Body7.

        Comma separated string of media sections, one for each media ID that this job applies to. Required only for `job_type` of `algorithm`.  # noqa: E501

        :param sections: The sections of this Body7.  # noqa: E501
        :type: str
        """
    ...
    @swid.setter
    def swid(self, swid):
        """Sets the swid of this Body7.

        UUID generated for the service worker that is doing an upload. This field is required if the `job_type` is `upload`.  # noqa: E501

        :param swid: The swid of this Body7.  # noqa: E501
        :type: str
        """
    ...
    @property
    def uid(self):
        """Gets the uid of this Body7.  # noqa: E501
        ...
        :return: The uid of this Body7.  # noqa: E501
        :rtype: str
        """
        return self._uid
    ...
    @uid.setter
    def uid(self, uid):
        """Sets the uid of this Body7.

        UUID generated for the individual job. This value is returned in the response of the `AlgorithmLaunch` and `Transcode` endpoints.  # noqa: E501

        :param uid: The uid of this Body7.  # noqa: E501
        :type: str
        """
        if uid is None:
