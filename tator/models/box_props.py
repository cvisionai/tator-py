...
class BoxProps(object):
    ...
    def __init__(self, height=None, width=None, x=None, y=None, local_vars_configuration=None):  # noqa: E501
        """BoxProps - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def height(self):
        """Gets the height of this BoxProps.  # noqa: E501

        Normalized height of bounding box for `box` localization types.  # noqa: E501

        :return: The height of this BoxProps.  # noqa: E501
        :rtype: float
        """
        return self._height
    ...
    def height(self, height):
        """Sets the height of this BoxProps.

        Normalized height of bounding box for `box` localization types.  # noqa: E501

        :param height: The height of this BoxProps.  # noqa: E501
        :type: float
        """
    ...
    @property
    def width(self):
        """Gets the width of this BoxProps.  # noqa: E501

        Normalized width of bounding box for `box` localization types.  # noqa: E501

        :return: The width of this BoxProps.  # noqa: E501
        :rtype: float
        """
        return self._width
    ...
    def width(self, width):
        """Sets the width of this BoxProps.

        Normalized width of bounding box for `box` localization types.  # noqa: E501

        :param width: The width of this BoxProps.  # noqa: E501
        :type: float
        """
    ...
    @property
    def x(self):
        """Gets the x of this BoxProps.  # noqa: E501

        Normalized horizontal position of left edge of bounding box.  # noqa: E501

        :return: The x of this BoxProps.  # noqa: E501
        :rtype: float
        """
        return self._x
    ...
    @x.setter
    def x(self, x):
        """Sets the x of this BoxProps.

        Normalized horizontal position of left edge of bounding box.  # noqa: E501

        :param x: The x of this BoxProps.  # noqa: E501
        :type: float
        """
    ...
    @property
    def y(self):
        """Gets the y of this BoxProps.  # noqa: E501

        Normalized vertical position of top edge of bounding box.  # noqa: E501

        :return: The y of this BoxProps.  # noqa: E501
        :rtype: float
        """
        return self._y
    ...
    @y.setter
    def y(self, y):
        """Sets the y of this BoxProps.

        Normalized vertical position of top edge of bounding box.  # noqa: E501

        :param y: The y of this BoxProps.  # noqa: E501
        :type: float
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BoxProps):
            return False
