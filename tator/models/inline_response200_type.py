...
class InlineResponse200Type(object):
    ...
    def __init__(self, color_map=None, description=None, dtype=None, id=None, line_width=None, name=None, resourcetype=None, local_vars_configuration=None):  # noqa: E501
        """InlineResponse200Type - a model defined in OpenAPI"""  # noqa: E501
