...
class StateType(object):
    ...
    def __init__(self, association=None, attribute_types=None, description=None, dtype=None, id=None, interpolation='latest', media=None, name=None, project=None, visible=None):  # noqa: E501
